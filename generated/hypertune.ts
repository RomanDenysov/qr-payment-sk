...
export const queryCode = `query FullQuery{root{appleSignUp}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"appleSignUp":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"appleSignUp":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/5441/main/draft/logic?selected_field_path=root%3EappleSignUp","description":"Enable Social signIn and signUp with apple provider"}};
...
export type Root = {
  /**
   * Enable Social signIn and signUp with apple provider
   */
  appleSignUp: boolean;
}

const rootFallback = {appleSignUp:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * Enable Social signIn and signUp with apple provider
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/5441/main/draft/logic?selected_field_path=root%3EappleSignUp})
   */
  appleSignUp({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("appleSignUp", { fieldArguments: args });
...
const sourceFallback = {root:{appleSignUp:false}};
